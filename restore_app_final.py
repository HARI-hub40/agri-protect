...
def restore():
    ...
    # Using simple strings without emojis to avoid encoding errors
    middle = [
        ...
        '        return {\n',
        '            "alerts": [\n',
        '                {"title": "Fungal Disease Risk", "level": "high", "message": f"Humidity {q.humidity}% is high. Spray Mancozeb.", "crop": "Tomato, Rice", "icon": "!"},\n',
        '                {"title": "Pest Activity Alert", "level": "medium", "message": f"Temperature {q.temp} C favors pests. Use Neem oil.", "crop": "Chilli, Brinjal", "icon": "!"},\n',
        '                {"title": "Irrigation Advisory", "level": "low", "message": "Check soil moisture.", "crop": "All Crops", "icon": "!"}\n',
        '            ],\n',
    ...
    try:
        ...
        if GEMINI_API_KEY:
            try:
                ...
                if user_id:
                    save_history(user_id, result['disease'], confidence, result['severity'], result.get('crop', crop))
